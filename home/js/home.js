...
html1 +=    "<img src=images/keurig.png alt=Keurig.org>";
html1 +=    "<p>Keurig News HQ</p>";
html1 +=    "</a>";
html1 +=    "</li>";
...
html1 +=    "<img id=mgm src=images/mgm2.png alt=MGM Macau>";
html1 +=    "<p>MGM Macau News HQ</p>";
html1 +=    "</a>";
html1 +=    "</li>";
...
html1 +=    "<p>Play some craps</p>";
html1 +=    "</a>";
html1 +=    "</li>";

html1 +=    "<li>";
html1 +=    "<a href=https://codepen.io/bigreed_76/pen/OXAjqb>";
html1 +=    "<img src=images/film.png alt=CrapsGame>";
